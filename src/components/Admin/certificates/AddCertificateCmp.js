...
export default function AddCertificateCmp({hide,show}) {
    function resetInput(){
        setInput({
            companyAddress:'',
            manufacturer:'',
...
const itemSubmit = (e) =>{
    ...
    const data = {
        ...
        axios.post('/api/create-certificate',data).then(res =>{
  ...
  return (
<Modal title="Add certificate" hide={hide} show={show} >
    ...
    <div>
        ...
        <button type="submit" className="self-center w-[50%] bg-blue-500 hover:bg-blue-700 rounded-full py-3 text-white font-bold">Add Certificate</button>
