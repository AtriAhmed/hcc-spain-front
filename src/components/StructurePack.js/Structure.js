        ...
        <FadeUpOnScroll>
          <div className="pt-8 flex flex-col items-center md:flex-row gap-8">
            <p className="font-open font-normal text-base text-center md:text-left text-slate-900">
              Mr. Ben Ali-Salah and Mr. Ali Boukhelifa (may Allah have mercy on him) are the founders of Halal Correct Germany, a proud member of the Halal Correct Certification Group and a leading force in the Halal food market in France and Europe.
              <br />
