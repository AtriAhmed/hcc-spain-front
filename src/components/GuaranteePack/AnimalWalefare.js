        ...
        <FadeUpOnScroll>
          <div className="pt-8 flex flex-col items-center md:flex-row gap-8">
            <p className="font-open font-normal text-base text-center md:text-left text-slate-900">
              ...
              procedure of HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED certification. The traditional and
              ...
              welfare. HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED Certification is also part of the committee
