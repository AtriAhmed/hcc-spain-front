        ...
        <FadeUpOnScroll>
          <div className="pt-8 flex flex-col items-center md:flex-row gap-8">
            ...
            The guarantee for quality and continuity plays a pivotal concern
              at Halal correct France system. We use a structural procedure to select,
              ...
              <br />
              <br />
              The Halal correct France Certification activities are according to ISO
              ...
              Halal correct France Certification will always be striving to improve its
