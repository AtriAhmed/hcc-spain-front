...
const data = [
  {
    label: "Use of the HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED logo",
    value: "tab1",
    desc: (
      <>
        HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED logo is registered at Benelux office for Intellectual
        Property. Any kinds of use for our logo need to be communicated with us.
        The third parties is allowed to use the logo only if HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED has
        given its written consent.
        <br />
        <br />
        The use of the logo on packaging is only allowed for clients who have a
        contract with HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED Certification and who were given written
  ...
  {
    label: "HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED certificates",
    value: "tab2",
    desc: (
      <>
        ...
        <br />
        <br />
        The HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED certificates are intended for the clients and their
        customers to guarantee the dignity of the halal products. It is strictly
        prohibited to use the HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED certificates as proof of halal
