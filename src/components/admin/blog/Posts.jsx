...
export default function Blogs() {
    ...
    const deleteItem = (e, item) => {
        ...
        Swal.fire({
            title: 'Delete Blog',
            text: `Are you sure to delete ${item.title_en || item.title_nl || item.title_ar} ?`,
            showDenyButton: true,
                        ...
                        {itemsList?.length > 0 ?
                            <>
                                <div className='mx-0 grid grid-cols-12 text-center break-all'>
                                    ...
                                    <div className='pb-3 text-start col-span-3'>Image</div>
                                    <div className='pb-3 text-start col-span-6 sm:col-span-4'>Title</div>
                                    ...
                                    {itemsList?.map((item) => {
                                        return (
                                            ...
                                            <div key={item.id} className="mx-0 grid grid-cols-12 text-center break-all">
                                                ...
                                                <div className='pt-3 col-span-3'><img className='w-[70px] sm:w-[130px] md:w-[160px]' src={`${process.env.GATSBY_API_URL}${item.image}`} alt="" /></div>
                                                <div className='pt-3 text-start col-span-6 sm:col-span-4'><div className='font-bold'>{item.title_en || item.title_ar || item.title_nl}</div> </div>
                                                ...
                                                <div className='pt-3 text-end sm:text-center col-span-1 sm:col-span-2'>
                                                    <div className='grid grid-cols-12'>
                                                        <div className='col-span-12 sm:col-span-6 flex justify-end sm:justify-center'><Link className='text-center' to={`/admin/blog/${item.slug}`} ><PencilSquareIcon className="block h-8 w-8 text-blue-600" aria-hidden="true" /></Link></div>
                                                        <div className='col-span-12 sm:col-span-6 flex justify-end sm:justify-center'><button type='button' onClick={(e) => { deleteItem(e, item); }}><TrashIcon className="block h-8 w-8 text-red-600" aria-hidden="true" /></button></div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="flex flex-col gap-4 items-center justify-center text-center h-[25vh]">
                                ...
                                <h3 className='text-2xl font-bold'>Theres no posts</h3>
