  ...
  return (
    ...
    >
      <div className="absolute w-full h-full overflow-hidden">
        ...
        <img src={heroImg} alt="" className="object-cover h-full w-full z-0 relative" />
          ...
          <div className="p-10 w-full md:w-[900px] lg:w-[600px] mx-auto lg:mx-0 flex flex-col gap-6 lg:gap-12 items-center lg:items-start bg-[rgba(0,0,0,0.2)]">
            <h1 className="capitalize font-poppins font-bold text-white text-4xl transition-all duration-1000 lg:text-5xl text-center lg:text-left">
              ...
              <div className="text-sm font-normal text-justify mt-2">
                Halal Correct Germany is committed to being your trusted partner for halal certification. With our expertise and unwavering dedication to upholding halal integrity, we guarantee that your products will meet the highest standards of halal certification.
              </div>
            </h1>
