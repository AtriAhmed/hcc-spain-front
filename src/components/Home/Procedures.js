...
const procedures = [
  ...
  {
    text: "An application system for a Halal Certificate has been established by HCC EAST AFRICAN HALAL CONFIRMATION CENTER LIMITED Certification. The completion of the audit program is based on the size, scope, products, processes, level of the management system and the results of previous audits of the organization.",
  },
]
